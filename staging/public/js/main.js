...
esriApp.controller('UIController', ['$scope', function ($scope) {
    ...
    require(['esri/map', 'esri/arcgis/utils', 'esri/config', 'esri/urlUtils', 'esri/geometry/Point', 'esri/SpatialReference', 'esri/toolbars/draw', 'esri/graphic', 'esri/tasks/GeometryService', 'esri/geometry/webMercatorUtils', 'dojo/domReady!'], function (Map, arcgisUtils, esriConfig, urlUtils, Point, SpatialReference, Draw, Graphic, GeometryService, webMercatorUtils) {
        var map = null;
