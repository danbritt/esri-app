...
esriApp.controller('UIController', ['$scope', function ($scope) {
    ...
    require(['esri/map', 'esri/arcgis/utils', 'esri/config', 'esri/urlUtils', 'esri/geometry/Point', 'esri/SpatialReference', 'esri/toolbars/draw', 'esri/graphic', 'esri/tasks/GeometryService', 'esri/geometry/webMercatorUtils', 'esri/tasks/query', 'esri/symbols/SimpleMarkerSymbol', 'esri/symbols/SimpleLineSymbol', 'esri/Color', 'esri/layers/FeatureLayer', 'esri/geometry/screenUtils', 'dojo/domReady!'], function (Map, arcgisUtils, esriConfig, urlUtils, Point, SpatialReference, Draw, Graphic, GeometryService, webMercatorUtils, Query, SimpleMarkerSymbol, SimpleLineSymbol, Color, FeatureLayer, screenUtils) {
        var map = null;
